const int trig1Pin = 10; 	const int trig2Pin = 2; // 11
const int echo1Pin = 11; 	const int echo2Pin = 3; // 10
const int output1Pin = 7;	const int output2Pin = 5;
...
void loop()
{
	...
	feedbackOutput(output1Pin,distance1,'b');
